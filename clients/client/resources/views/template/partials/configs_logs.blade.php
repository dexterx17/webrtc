    ...
    <div class="side-nav-wrapper">
        <div class="col s12">
            <ul class="tabs tab-demo" style="width: 100%;">
                <li class="tab col s3"><a href="#sidebar-chat-tab" class="active">CLIENTES</a></li>
                <li class="tab col s3"><a href="#sidebar-more-tab" class="active">LOGS</a></li>
                <!--<li class="tab col s3"><a href="#sidebar-more-tab">CONFIGS</a></li>-->
            </ul>
        </div>
        <div id="sidebar-chat-tab" class="col s12 sidebar-messages right-sidebar-panel">
            <p class="right-sidebar-heading">CLIENTES CONECTADOS</p>
            <div class="chat-list" id="list-clientes-conectados">
        ...
        <div id="sidebar-more-tab" class="col s12 sidebar-messages right-sidebar-panel">
            <p class="right-sidebar-heading">LOG</p>
            <div class="chat-list">
                <a href="javascript:void(0)" class="chat-message">
                    <div class="chat-item">
                        ...
                        <div class="chat-item-info">
                            <p class="chat-name">visualizador</p>
                            <span class="chat-message">Visualizador</span>
                        </div>
                    </div>
                </a>
            </div>
